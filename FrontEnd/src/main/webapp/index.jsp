  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <img src ="https://spiderimg.amarujala.com/assets/images/2019/04/20/750x506/best-smart-phones-under-10000_1555756046.jpeg" style="width:1000px;height:490px;margin: 0 auto;">
        <div class="carousel-caption">
          <h3 class="glyphicon glyphicon-tongue">Smart Mobile Phones</h3>
        </div>
      </div>

      <div class="item">
        <img src="https://i.gadgets360cdn.com/products/large/1529877080_635_xiaomi_redmi_6_pro.jpg" style="width:1000px;height:490px;margin: 0 auto;">
        <div class="carousel-caption">
          <h3>Redmi</h3>
        </div>
      </div>
      ...
      <div class="item">
        ...
        <div class="carousel-caption">
          <h3>Collection of Latest Mobile phones</h3>
        </div>
      </div>
